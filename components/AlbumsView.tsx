...
import { Disc, LayoutGrid, List, ArrowLeft, Clock, Music2 } from 'lucide-react';
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="flex items-center gap-4 mt-2 text-sm text-zinc-500 font-medium">
                            <div className="flex items-center gap-1">
                                ...
                                <span>{albumSongs.length} músicas</span>
                            </div>
                            <div className="w-1 h-1 rounded-full bg-zinc-600" />
                            <div className="flex items-center gap-1">
                                <Clock className="w-4 h-4" />
                                <span>{formatTotalTime(albumSongs.reduce((acc, s) => acc + s.duration, 0))}</span>
                            </div>
                        </div>
                    </div>
